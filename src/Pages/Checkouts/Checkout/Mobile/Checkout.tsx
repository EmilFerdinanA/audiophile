...
import { IOrder } from "@/constant/Order";
...
export const CheckoutMobile = () => {
  ...
  return (
    <div>
      <section className="mx-6 sm:mx-10 xl:mx-40 mt-4 mb-6 sm:mt-8 xl:mt-20 xl:mb-14 bg-tertiary rounded-lg p-6">
      ...
      <section className="mx-6 bg-[#cfcfcf] rounded-lg px-6 sm:mx-10 xl:mx-40 py-8">
        ...
        <div className="flex flex-col gap-2 mt-8">
          ...
          <button
            ...
            className="bg-primary h-12 text-senary font-bold mt-6"
          >
            CONTINUE & PAY
          </button>
        </div>
